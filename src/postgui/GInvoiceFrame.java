 ...
 * @author Tony
 */
public class GInvoiceFrame extends javax.swing.JFrame {

    /**
     * Creates new form GInvoiceGrame
     */
    public GInvoiceFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        gInvoicePanel = new postgui.GInvoicePanel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GInvoiceFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GInvoiceFrame().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private postgui.GInvoicePanel gInvoicePanel;
